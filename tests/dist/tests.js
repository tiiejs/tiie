...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./topi.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./topi.scss");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!./jquery.datetimepicker.min.css", function() {
			var newContent = require("!!../../css-loader/index.js!./jquery.datetimepicker.min.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
class Content {
    constructor() {
        ...
        p.content = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`
            <div style="
                width: 70%;
                margin: 0 auto;
                padding: 20px;
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()("body").prepend(p.content)
    }
    ...
    body() {
        return __WEBPACK_IMPORTED_MODULE_0_jquery___default()("body");
    }
